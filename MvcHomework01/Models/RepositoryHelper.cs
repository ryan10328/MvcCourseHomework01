namespace MvcHomework01.Models
{
	public static class RepositoryHelper
	{
		...
		public static VWCustomerInformationRepository GetVWCustomerInformationRepository()
		{
			var repository = new VWCustomerInformationRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static VWCustomerInformationRepository GetVWCustomerInformationRepository(IUnitOfWork unitOfWork)
		{
			var repository = new VWCustomerInformationRepository();
